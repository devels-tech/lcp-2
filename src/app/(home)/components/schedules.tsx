      ...
      <div className='overflow-hidden rounded-3xl bg-gradient-to-r from-[#1e478d] to-blue-800'>
        <div className='grid lg:grid-cols-2'>
          ...
          <div className='relative bg-orange-500'>
            <div className='absolute right-4 top-4 rounded-lg bg-white/10 p-2 backdrop-blur-sm z-10'>
              <div className='text-2xl font-bold text-white'>Bienvenidos</div>
              <div className='text-sm text-white'>a nuestra comunidad</div>
            </div>
