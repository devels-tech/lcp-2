        ...
        <motion.div ref={carousel} className='cursor-grab overflow-hidden'>
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                key={index}
                className='min-w-[300px] h-[400px] p-8 m-4 bg-background rounded-3xl shadow-lg flex flex-col justify-between transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg transition-all duration-300 ease-in-out border-2 border-transparent hover:border-primary/10'
              >
                <div>
